...
class SearchServiceStub:
    ...
    def __init__(self, channel):
        ...
        """
        self.ExecuteSearch = channel.unary_unary(
                '/search.engine.v1.SearchService/ExecuteSearch',
...
class SearchServiceServicer:
    ...
    def ExecuteSearch(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_SearchServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'search.engine.v1.SearchService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('search.engine.v1.SearchService', rpc_method_handlers)
